...
I'd rather spare you the frustration I just went through.
...
that XML handling in Java is an exercise in obfuscation and it would probably be much quicker to implement a solution
