...
res1: List[(Int, String, Boolean)] = List((1,Nicolas,true), (2,Jessica,false), (3,Matt,false))
```
...
```scala
scala> parseCsv[(Int, String, Boolean)](Source.fromString(input)).toList
res4: List[(Int, String, Boolean)] = List((1,Nicolas,true), (2,Jessica,false), (3,Matt,false))
```
...
res6: List[IndexedSeq[Int]] = List(Vector(1, 2, 3), Vector(4, 5, 6), Vector(7, 8, 9))
```
...
res8: List[Vector[Int]] = List(Vector(1, 2, 3), Vector(4, 5, 6), Vector(7, 8, 9))
```
...
res9: List[(Int, String, Either[Boolean,Int])] = List((1,Nicolas,Left(true)), (2,Jessica,Right(36)))
```
...
res10: List[(Int, String, Either[Boolean,Either[Int,String]])] = List((1,Nicolas,Left(true)), (2,Jessica,Right(Left(36))), (3,Matt,Right(Right(Joe))))
```
...
res11: List[(Int, Option[String], Boolean)] = List((1,Some(Nicolas),true), (2,None,false), (3,Some(Matt),false))
```
...
res12: List[List[Option[Int]]] = List(List(Some(1), None, Some(2)), List(None, Some(3), Some(4)))
```
...
res14: List[Person] = List(Person(1,Nicolas), Person(2,Jessica), Person(3,Matt))
```
...
res15: List[(Option[Either[Boolean,String]], Int)] = List((None,1), (Some(Left(true)),2), (Some(Right(foobar)),3))
```
...
res17: List[Option[Either[Int,Boolean]]] = List(Some(Left(1)), Some(Left(2)), Some(Left(3)), Some(Left(4)))
```
